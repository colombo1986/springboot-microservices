            ...
            <div><br/><br/>
                <div className='card col-md-6 offset-md-3'>
                    ...
                    <div className='card-body'>
                        ...
                        <div className='row'>
                            <p><strong>Department Description: </strong> {this.state.department.departmentDescription}
                            </p>
                        </div>
                        <div className='row'>
                    ...
                    <div className='card-body'>
                        ...
                        <div className='row'>
                            <p><strong> Organization
                                Description: </strong> {this.state.organization.organizationDescription} </p>
                        </div>
                        <div className='row'>
